...
export_keys_to_windows() {
    ...
    WIN_KEY="C:\\Users\\$USER_NAME\\AppData\\Local\\Temp\\all_keys.asc"
...
export_ownertrust_to_windows() {
    ...
    WIN_TRUST="C:\\Users\\$USER_NAME\\AppData\\Local\\Temp\\all_trust.txt"
...
import_windows_keys() {
    ...
    WIN_PUBLIC_KEY=$(wslpath "C:\\Users\\$USER_NAME\\AppData\\Local\\Temp\\all_public_keys.asc")
    WIN_SECRET_KEY=$(wslpath "C:\\Users\\$USER_NAME\\AppData\\Local\\Temp\\all_secret_keys.asc")
...
import_windows_ownertrust() {
    ...
    WIN_TRUST=$(wslpath "C:\\Users\\$USER_NAME\\AppData\\Local\\Temp\\all_trust.txt")
